...
export class UsersService {
  ...
  //create and encrypt password (10 additional keys) -- return secure user to Model from Document
  ...
  //Map the documen to the model (ensures return a model) [don't pass password]
